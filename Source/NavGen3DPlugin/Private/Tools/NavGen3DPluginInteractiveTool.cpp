...
#include "NavGen3DPluginInteractiveTool.h"
...
UInteractiveTool* UNavGen3DPluginInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UNavGen3DPluginInteractiveTool* NewTool = NewObject<UNavGen3DPluginInteractiveTool>(SceneState.ToolManager);
...
UNavGen3DPluginInteractiveToolProperties::UNavGen3DPluginInteractiveToolProperties()
{
...
void UNavGen3DPluginInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UNavGen3DPluginInteractiveTool::Setup()
{
	...
	Properties = NewObject<UNavGen3DPluginInteractiveToolProperties>(this, "Measurement");
...
void UNavGen3DPluginInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UNavGen3DPluginInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UNavGen3DPluginInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UNavGen3DPluginInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UNavGen3DPluginInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UNavGen3DPluginInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UNavGen3DPluginInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UNavGen3DPluginInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UNavGen3DPluginInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{

...
#include "NavGen3DPluginInteractiveTool.generated.h"


/**
 * Builder for UNavGen3DPluginInteractiveTool
 */
UCLASS()
class NAVGEN3DPLUGIN_API UNavGen3DPluginInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UNavGen3DPluginInteractiveTool
 */
UCLASS(Transient)
class NAVGEN3DPLUGIN_API UNavGen3DPluginInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UNavGen3DPluginInteractiveToolProperties();
...
/**
 * UNavGen3DPluginInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class NAVGEN3DPLUGIN_API UNavGen3DPluginInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UNavGen3DPluginInteractiveToolProperties> Properties;
